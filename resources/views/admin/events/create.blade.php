        ...
        <div class="bg-white rounded-lg shadow p-6">
            <form method="POST" action="/admin/events">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="location" value="{{ old('location') }}" placeholder="cth: Gedung A, Lantai 2, Ruang Seminar, Jl. ..." class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                <div class="mb-6">
